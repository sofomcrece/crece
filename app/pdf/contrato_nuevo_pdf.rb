class ContratoNuevoPdf < Prawn::Document
  ...
  ",:size =>10,:align => :justify 
      ...
      text "I. DECLARA “LA ACREDITANTE”, A TRAVÉS DE SU REPRESENTANTE:",:size =>10,:align => :justify 
      text "A) Que es una sociedad mercantil constituida de conformidad con las leyes de los Estados Unidos Mexicanos, según consta en la escritura pública número 13,821 volumen xlii (cuadragésimo segundo) de fecha 13 de marzo del año 2088 (dos mil ocho), otorgada ante la fé del licenciado René González obeso notario público número 156 (ciento cincuenta y seis) del estado de Sinaloa, inscrita en el registro público de la propiedad y del comercio de Culiacán, Sinaloa., bajo el folio mercantil número 77503-1.",:size =>10,:align => :justify 
      text "B) Estar inscrita en el registro federal de contribuyentes con la clave FMA080313IJ5." ,:size =>10 ,:align => :justify
      text "C) Que tiene su domicilio es Río Nazas No. 1240 Colonia Los Pinos, Código Postal 80128, Culiacán, Sinaloa." , :align  => :center,:size =>10       
      text "D) Que, para su constitución y operación con carácter de Sociedad Financiera de Objeto Múltiple Entidad no Regulada, no requiere de autorización de la Secretaria de Hacienda y Crédito Público y únicamente está sujeta a la supervisión de la Comisión Nacional Bancaria y de Valores para efectos del artículo 56 de la Ley General de Organizaciones y Actividades Auxiliares del Crédito.", :align  => :center,:size =>10          
      text "E) Que el Señor #{Conf.last.representante_legal}, tiene facultades para la celebración del presente contrato, según consta en la escritura pública número ________________ de fecha #{@credit.fecha_en_español}, y que dichas facultades no le han sido revocadas ni modificadas en forma alguna." , :align  => :center,:size =>10                            
      text "F) Que conforme a su  objeto  social,  está  interesada  en  otorgar  a  “EL ACREDITADO”   un  crédito  por  la  cantidad, características y con las condiciones que más adelante se señalan, toda vez que la información que éste ha proporcionado a “LA ACREDITANTE” lo hace aparecer como persona solvente moral y económicamente y por lo tanto sujeto de crédito." , :align  => :center,:size =>10                            
      text "II.- DECLARA “EL ACREDITADO”:",:size =>10,:align => :justify 
      text "A) Ser mexicano (a), mayor de edad, con capacidad legal suficiente para celebrar el contrato, obligándose consecuentemente a los términos del mismo." , :align  => :center,:size =>10                            
      text "B) Sus datos generales son los que han quedado asentados en la solicitud de crédito.",:size =>10,:align => :justify 
      text "C) Que previamente a la firma del presente contrato “LA ACREDITANTE”, le ha informado y explicado a “EL ACREDITADO” el contenido del mismo y de todos los documentos a suscribir, los cargos, comisiones y/o gastos que en su caso se generaran por su celebración y, en su caso, los descuentos o bonificaciones a que tiene derecho; así como que este producto no genera comisiones.",:size =>10,:align => :justify 
      text "D) Que “LA ACREDITANTE” le informó el Costo Anual Total (CAT): el Costo Anual Total de Financiamiento expresado en términos porcentuales anuales que, para fines informativos y de comparación, incorpora la totalidad de los costos y gastos inherentes a los créditos." ,:size =>10,:align => :justify 
      ...
      text "CLAÚSULAS" , :align  => :center, :style=> :bold
      text "MONTO AUTORIZADO
PRIMERA. El crédito autorizado por “LA ACREDITANTE” es el señalado en la carátula del presente contrato, como monto del crédito autorizado, que le otorgará a favor de “EL ACREDITADO”.
",:size =>10,:align => :justify 
      ...
      text "Cada vez que “EL ACREDITADO” efectúe un pago anticipado, “LA ACREDITANTE” deberá entregarle un comprobante de dicho pago, así como la tabla de amortización correspondiente, junto con el estado de cuenta siguiente. Tratándose de pagos anticipados por un importe igual al saldo insoluto, “LA ACREDITANTE” además del comprobante del pago, deberá entregar o mantener a disposición de “EL ACREDITADO”, ",:size =>10,:align => :justify
      ...
      text "QUINTA. En caso de incumplimiento de la obligación de pago, según lo pactado en la cláusula tercera de este contrato el acreditado se obliga a pagar una tasa fija de interés moratorio del __________% anual, calculada diariamente sobre el capital devengado y no pagado, aplicable desde el día siguiente en que incurrió en mora y hasta el día en que se efectúe el pago total del adeudo.",:size =>10,:align => :justify
      ...
      text "IV. En caso de que la institución no diere respuesta oportuna a la solicitud del Cliente o no le entregare el dictamen e informe detallado, así como la documentación o evidencia antes referidos, la Comisión Nacional para la Protección y Defensa de los Usuarios de los Servicios Financieros, impondrá multa en los términos previstos en la fracción XI del artículo 43 de esta Ley por un monto equivalente al reclamado por el Cliente en términos de este artículo, y",:size =>10,:align => :justify
      text "V. Hasta en tanto la solicitud de aclaración de que se trate no quede resuelta de conformidad con el procedimiento señalado en este artículo, la institución no podrá reportar como vencidas las cantidades sujetas a dicha aclaración a las sociedades de información crediticia.",:size =>10,:align => :justify
      ...
      text "VIGENCIA Y MODIFICACIÓN",:size =>10,:align => :justify
      ...
      text "CANCELACIÓN Y TERMINACIÓN ANTICIPADA",:size =>10,:align => :justify
      ...
      text "text 'RESCISIÓN DEL CONTRATO'",:size =>10,:align => :justify
      ...
      text "ANEXO DE DISPOSICIONES JURÍDICAS",:size =>10,:align => :justify
      ...
      text "DOMICILIOS",:size =>10,:align => :justify
      ...
      text "LEYES APLICABLES Y JURISDICCIÓN",:size =>10,:align => :justify
      ...
      text "TÍTULOS DE LAS CLÁUSULAS
      DÉCIMA SÉPTIMA. Los títulos de las cláusulas que aparecen en el presente instrumento se han puesto con el exclusivo propósito de facilitar su lectura por tanto no definen ni limitan el contenido de las mismas. Para efectos de interpretación de este instrumento deberá atenderse exclusivamente al contenido de sus declaraciones y cláusulas y de ninguna manera al título de estas últimas
      Leído y comprendido el presente contrato, y enteradas las partes que intervienen de su contenido, alcances, consecuencias legales y económicas, lo firman de conformidad a los _________ días del mes de _______________________ de 20_____ en la ciudad de Culiacán, Sinaloa y en este acto se hace entrega una copia  a  cada  una  de  las  partes  que  intervienen  en  el  presente contrato, de este instrumento y sus respectivos anexos.
      ",:size =>10,:align => :justify
