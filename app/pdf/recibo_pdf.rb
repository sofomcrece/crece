class ReciboPdf < Prawn::Document
  ...
  def text_content
    ...
    @tickets.each do |ticket|  
      ...
      draw_text "INBURSA      50060343855       036730500603438554      4658 2858 0047 5869",:size=>7, :at => [70,528+des]
      draw_text "BAJIO        112248540201      030730900002594213",:size=>7, :at => [70,520+des]
