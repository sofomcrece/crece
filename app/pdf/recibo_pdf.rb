class ReciboPdf < Prawn::Document
  ...
  def text_content
    ...
    @tickets.each do |ticket|  
      ...
      draw_text "CUENTAS BANCARIAS PARA REALIZAR SUS PAGOS",:size=>7, :at => [70,568+des]
      draw_text "A NOMBRE DE: FINANCIERA MARJO, S.A. DE C.V., SOFOM, ENR",:size=>7, :at => [70,560+des]
