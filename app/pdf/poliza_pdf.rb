class PolizaPdf < Prawn::Document
  ...
  def text_content
    ...
    des = 0
    draw_text  "CRECE PRESTACIONES S.A.P.I. E C.V. SOFOM ENR",:size=>9, :at => [70,720+des]
    ...
    image "#{Rails.root}/app/assets/images/logo crece.png", width: 105, height: 85, :at => [70,600+des]
