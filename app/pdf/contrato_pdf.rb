class ContratoPdf < Prawn::Document
  ...
  def text_content
    ...
    sucesivo CRECE PRESTACIONES) en su calidad de Acreedor, en   sus   oficinas   con   Domicilio: #{Conf.last.domicilio}, y/o en la cuenta bancaria _________, CLABE ________, BANCO	_____________, la cantidad total de $#{Dinero.to_money(@credit.monto_solicitud)}(), correspondiente al principal, a los intereses ordinarios y   la   comisión   por   apertura,   mediante   pagos   conforme   a   la   tabla   de   amortización debidamente firmada por el DEUDOR.",:size =>8,:align => :justify
    text " "
