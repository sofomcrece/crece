class ContratoPdf < Prawn::Document
  ...
  def text_content
    ...
    text " "
    text "E) Que el Sr(a) #{Conf.last.representante_legal} tiene facultades para la celebración del presente contrato, según consta en la escritura pública número, de fecha #{@credit.fecha_en_español} y que dichas facultades no le han sido revocadas ni modificadas en forma alguna.",:size =>10,:align => :justify 
    text " "
