class ContratoPdf < Prawn::Document
  ...
  def text_content
    ...
    text " "
    text "B) Estar inscrita en el Registro Federal de Contribuyentes con la clave #{@conf.RFC} " , :align  => :justify,:size =>10       
    text " "
    text "C) Que tiene su domicilio en #{@conf.domicilio} "  , :align  => :justify,:size =>10          
    text " "
