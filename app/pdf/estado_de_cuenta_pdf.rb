  ...
  def text_content
    ...
    @credits.each do |credit| 
      ...
      table([
        ...
        ["Interes pagado: #{Dinero.to_money credit.interes_pagado}","Interes Vencido: #{Dinero.to_money credit.interes_vencido}","Fecha Limite de Pago: #{Auxiliar.fecha_natural(limPago)}"],
