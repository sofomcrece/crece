class CaratulaPdf < Prawn::Document
  ...
  def text_content
      ...
      draw_text  "#{@credit.product.loan.nombre}",:size=>9, :at => [140,672]
      ...
      draw_text  "www.financieramarjo.com.mx",:size=>9, :at => [140,203]
      draw_text  "#{Conf.last.correo}",:size=>9, :at => [390,217]
