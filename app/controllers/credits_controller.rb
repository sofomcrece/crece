class CreditsController < ApplicationController
  ...
  def create
    ...
    Customer.create(credit_params.except(:croquis,:fecha,:es_cliente,:monto_solicitud,:cada_cuanto_se_realizara_el_pago,:lugar_donde_se_realizara_el_pago))
  ...
  def update
    respond_to do |format|
      if @credit.update(credit_params)
        format.html { redirect_to "/view_credits/#{@credit.id}", notice: 'Credit was successfully updated.' }
